        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body table-responsive p-0">
                        ...
                        @foreach($contacts as $key => $contact)
                            <tr aria-expanded="false">
                                <td id="contact-operation" width="150" data-status="{{ $contact->read }}" data-id="{{ $contact->id }}">
                                    <button type="button" data-toggle="modal" data-target="#contact_read" class="read-data badge badge-success badge-btn" style="border-width: 0!important;">
                                ...
                                <td>
                                    <a href="{{ url($contact->image) }}" target="_blank">
                                        <img src="{{ url($contact->image) }}" width="auto" height="100" alt="">
                                    </a>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="contact_read" tabindex="-1" role="dialog" aria-labelledby="modal-title" aria-hidden="true">
